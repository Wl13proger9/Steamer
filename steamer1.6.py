...
{hm} or just reinstall it from installer''')
    quit()


if not os.path.exists("./hellyeah/"):
    print(f"{hm}So you haven't repatch folder, just download it from github or reinstall from installer")
...
if repa != []:
    ...
    if input(f"{what} Do you want to patch it?[y/n]> ") == "y":
            ...
            input(f"{hm} If something went wrong, just restart it")
...
-games.zip archive url: https://mega.nz/file/EchSlZLL#BbT7-qtm26ZnaTpzpj0AjgNemHh6av68MyAN7IuTfOE
----------------------
''')
